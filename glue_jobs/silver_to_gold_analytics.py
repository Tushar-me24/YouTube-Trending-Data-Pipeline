...
SILVER_DB   = args["silver_database"]   # youtube-project-silver
GOLD_BUCKET = args["gold_bucket"]       # youtube-project-gold
GOLD_DB     = args["gold_database"]     # youtube-project-gold
...
trending_path = f"s3://youtube-project-gold/youtube/trending_analytics/"
...
channel_path = f"s3://youtube-project-gold/youtube/channel_analytics/"
...
category_path = f"s3://youtube-project-gold/youtube/category_analytics/"
